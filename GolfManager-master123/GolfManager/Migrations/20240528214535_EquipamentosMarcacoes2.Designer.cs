...
namespace WaveCenter.Migrations
{
    ...
    [Migration("20240528214535_EquipamentosMarcacoes2")]
    partial class EquipamentosMarcacoes2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WaveCenter.Model.EquipamentoMarcacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("EquipamentosMarcacoes");
                });
            ...
            modelBuilder.Entity("WaveCenter.Model.PedidoReparacaoEstados", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IdPedidoReparacao");

                    b.ToTable("PedidoReparacaoEstados");
                });
            ...
            modelBuilder.Entity("WaveCenter.Model.ClientesMarcacao", b =>
                {
                    b.HasOne("WaveCenter.Model.Marcacao", "Marcacao")
            ...
            modelBuilder.Entity("WaveCenter.Model.EquipamentoMarcacao", b =>
                {
                    ...
                    b.HasOne("WaveCenter.Model.Marcacao", "Marcacao")
                        .WithMany("EquipamentosMarcacoes")
            ...
            modelBuilder.Entity("WaveCenter.Model.Marcacao", b =>
                {
                    b.HasOne("WaveCenter.Model.Experiencia", null)
                        .WithMany("Marcacoes")
            ...
            modelBuilder.Entity("WaveCenter.Model.PedidoReparacaoEstados", b =>
                {
                    b.HasOne("WaveCenter.Model.PedidoReparacao", "PedidoReparacao")
                        .WithMany()
                        .HasForeignKey("IdPedidoReparacao")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PedidoReparacao");
                });
            ...
            modelBuilder.Entity("WaveCenter.Model.Marcacao", b =>
                {
                    ...
                    b.Navigation("EquipamentosMarcacoes");
                });
